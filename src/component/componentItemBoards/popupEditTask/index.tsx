                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2 items-center">
                                            ...
                                            <Date
                                                ...
                                                idTask={idTask}
                                                isShowDatePopup={isShowDatePopup.popupView}
                                                dates={dates}
                ...
                <div className="flex gap-[20px] justify-between">
                            ...
                            <div className="mt-[10px]">
                                {toggleShowContent ? (
                                    ...
                                    <div
                                        ...
                                        ref={contentElement}
                                        className="whitespace-pre-wrap break-words w-[488px] cursor-pointer"
                                    ></div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="w-[192px] pr-[16px]">
                        ...
                        <Date
                            ...
                            idTask={idTask}
                            isShowDatePopup={isShowDatePopup.popupRightBar}
                            dates={dates}
                            handleCloseDatePopup={handleCloseDatePopup}
                        >
                            <div
